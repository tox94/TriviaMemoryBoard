package com.zavrsni.unizg.fer.triviamemoryboard.levels.fifth;
...
public class FifthLevelActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        board = (ScrollView) findViewById(R.id.scrollView_board_level_5);

        table = (TableLayout) findViewById(R.id.table_board_level_5);

        score = (TextView) findViewById(R.id.textView_score_points);

        fragQuestion = (View) findViewById(R.id.question_fragment_level_5);
        fragQuestion.setVisibility(View.INVISIBLE);
        fragQuestion.setEnabled(false);

        fragMove = (View) findViewById(R.id.last_moves_fragment_level_5);
        fragMove.setVisibility(View.INVISIBLE);
        fragMove.setEnabled(false);

        fragNick = findViewById(R.id.nick_fragment_level_5);
    ...
    public void initTable(){
        ScrollView sv = (ScrollView) findViewById(R.id.scrollView_board_level_5);
    ...
    public void changeMovesFragment(){
        ...
        else if(reqMoves>1 && reqMoves<5)
            moves.setText("Smjer prethodna " + reqMoves + " poteza:");
        else if(reqMoves==5)
            moves.setText("Smjer prethodnih " + reqMoves + " poteza:");
    ...
    public void setClickableAndLocked(){
        ...
        setLc(new int[]{1, 2, 3, 12, 13, 22, 23, 33}, new int[]{50, 51, 52, 53, 62, 63, 72, 73, 83}, new int[]{35, 26, 36, 17, 27, 37, 8, 18, 28});
    ...
    public void changeClickable(int[] ints){
        ...
        try
        {
            for (int i : ints) {
                try {
                    if ((locked[i] == false || i == 1 || i == 50 || i == 35) && i >= 0 && i < fieldSize*fieldSize) {
    ...
    public void setLc (int[] ints1, int[] ints2, int[] ints3){
        ...
        setPermLocked(new int[]{20, 32, 41, 42, 47, 49, 57, 61, 67, 77, 78, 85, 88, 90, 93, 95});
    }
    ...
    public void changeLocked(int i){
        if(answer == true){
            if(i == 1){
                ...
                ImageView iv = (ImageView) tr0.getChildAt(1);
                unlock(new int[]{1, 2, 12, 22, 33});
                setPermLocked(new int[]{3, 13, 23});
                ...
                ImageView iv = (ImageView) tr5.getChildAt(0);
                unlock(new int[]{50, 51, 52, 62, 63, 73, 83});
                setPermLocked(new int[]{53, 72});
                if(fieldClicked[i] == false) {
                    int n = Integer.parseInt(score.getText().toString());
                    n += 50;
                    score.setText("" + n);
                ...
                ImageView iv = (ImageView) tr3.getChildAt(5);
                unlock(new int[]{35, 26, 27, 37, 28});
                setPermLocked(new int[]{36, 17, 8, 18});
                if(fieldClicked[i] == false) {
                    int n = Integer.parseInt(score.getText().toString());
                    n += 50;
                    score.setText("" + n);
    ...
    public void endLevel(){
        ...
        btnEnd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int ord = 0;
                try{
                    ArrayList<ResultFromDb> allResults = rep.getAllResultsForUser(nick, 5);
                ...
                if(ord == 0)
                    ord = 1;
                ResultFromDb result = new ResultFromDb(cnt, nick, 5, seconds, points, corMoves, incMoves, ord, corQ, incQ);
