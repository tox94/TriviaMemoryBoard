package com.zavrsni.unizg.fer.triviamemoryboard.levels.fourth;
...
public class FourthLevelActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        board = (ScrollView) findViewById(R.id.scrollView_board_level_4);

        table = (TableLayout) findViewById(R.id.table_board_level_4);

        score = (TextView) findViewById(R.id.textView_score_points);

        fragQuestion = (View) findViewById(R.id.question_fragment_level_4);
        fragQuestion.setVisibility(View.INVISIBLE);
        fragQuestion.setEnabled(false);

        fragMove = (View) findViewById(R.id.last_moves_fragment_level_4);
        fragMove.setVisibility(View.INVISIBLE);
        fragMove.setEnabled(false);

        fragNick = findViewById(R.id.nick_fragment_level_4);
    ...
    public void initTable(){
        ScrollView sv = (ScrollView) findViewById(R.id.scrollView_board_level_4);
    ...
    public void setClickableAndLocked(){
        ...
        setLc(new int[]{21, 30, 31, 40}, new int[]{46, 47, 48, 55, 56}, new int[]{51, 60, 61, 69, 70, 79});
    ...
    public void changeClickable(int[] ints){
        ...
        try
        {
            for (int i : ints) {
                try {
                    if ((locked[i] == false || i == 21 || i == 48 || i == 51) && i >= 0 && i < fieldSize*fieldSize) {
    ...
    public void setLc (int[] ints1, int[] ints2, int[] ints3){
        ...
        setPermLocked(new int[]{2, 7, 9, 14, 19, 22, 24, 29, 35, 39, 42, 43, 57, 63, 67, 68, 73});
    }
    ...
    public void changeLocked(int i){
        if(answer == true){
            if(i == 21){
                ...
                ImageView iv = (ImageView) tr2.getChildAt(3);
                unlock(new int[]{21, 30, 40});
                setPermLocked(new int[]{31});
                ...
                ImageView iv = (ImageView) tr5.getChildAt(3);
                unlock(new int[]{47, 48, 55});
                setPermLocked(new int[]{46, 56});
                if(fieldClicked[i] == false) {
                    int n = Integer.parseInt(score.getText().toString());
                    n += 50;
                    score.setText("" + n);
                ...
                TableRow tr5 = (TableRow) table.getChildAt(5);
                ImageView iv = (ImageView) tr5.getChildAt(6);
                unlock(new int[]{51, 69, 70});
                setPermLocked(new int[]{60, 61, 79});
                if(fieldClicked[i] == false) {
                    int n = Integer.parseInt(score.getText().toString());
                    n += 50;
                    score.setText("" + n);
    ...
    public void endLevel(){
        ...
        btnEnd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int ord = 0;
                try{
                    ArrayList<ResultFromDb> allResults = rep.getAllResultsForUser(nick, 4);
                ...
                if(ord == 0)
                    ord = 1;
                ResultFromDb result = new ResultFromDb(cnt, nick, 4, seconds, points, corMoves, incMoves, ord, corQ, incQ);
