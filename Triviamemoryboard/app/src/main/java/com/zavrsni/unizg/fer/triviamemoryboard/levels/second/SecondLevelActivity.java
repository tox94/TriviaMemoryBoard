package com.zavrsni.unizg.fer.triviamemoryboard.levels.second;
...
public class SecondLevelActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        board = (ScrollView) findViewById(R.id.scrollView_board_level_2);

        table = (TableLayout) findViewById(R.id.table_board_level_2);

        score = (TextView) findViewById(R.id.textView_score_points);

        fragQuestion = (View) findViewById(R.id.question_fragment_level_2);
        fragQuestion.setVisibility(View.INVISIBLE);
        fragQuestion.setEnabled(false);

        fragMove= (View) findViewById(R.id.last_moves_fragment_level_2);
        fragMove.setVisibility(View.INVISIBLE);
        fragMove.setEnabled(false);

        fragNick = findViewById(R.id.nick_fragment_level_2);
    ...
    public void initTable(){
        ScrollView sv = (ScrollView) findViewById(R.id.scrollView_board_level_2);
    ...
    public void setClickableAndLocked(){
        ...
        setLc(new int[]{7, 14, 15}, new int[]{31, 38}, new int[]{1, 2, 9});
    ...
    public void changeClickable(int[] ints){
        ...
        try
        {
            for (int i : ints) {
                try {
                    if ((locked[i] == false || i == 7 || i == 38 || i == 1) && i >= 0 && i < fieldSize*fieldSize) {
    ...
    public void setLc (int[] ints1, int[] ints2, int[] ints3){
        ...
        int[] perm = new int[]{3, 21, 16, 17, 18, 23, 25, 36, 12, 27, 40};
        setPermLocked(perm);
    }
    ...
    public void changeLocked(int i){
        if(answer == true){
            if(i == 7){
                ...
                ImageView iv1 = (ImageView) tr1.getChildAt(0);
                ImageView iv2 = (ImageView) tr2.getChildAt(0);
                ImageView iv3 = (ImageView) tr2.getChildAt(1);
                ...
                TableRow tr5 = (TableRow) table.getChildAt(5);
                ImageView iv2 = (ImageView) tr4.getChildAt(3);
                ImageView iv4 = (ImageView) tr5.getChildAt(3);
                iv2.setBackgroundResource(R.drawable.field_button_style_red);
                ...
                TableRow tr1 = (TableRow) table.getChildAt(1);
                ImageView iv1 = (ImageView) tr0.getChildAt(1);
                ImageView iv2 = (ImageView) tr0.getChildAt(2);
                ImageView iv3 = (ImageView) tr1.getChildAt(2);
                iv1.setBackgroundResource(R.drawable.field_button_style_red);
                iv2.setBackgroundResource(R.drawable.field_button_style_red);
                iv3.setBackgroundResource(R.drawable.field_button_style_red);
                if(fieldClicked[i] == false) {
    ...
    public void endLevel(){
        ...
        btnEnd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int ord = 0;
                try{
                    ArrayList<ResultFromDb> allResults = rep.getAllResultsForUser(nick, 2);
                ...
                if(ord == 0)
                    ord = 1;
                ResultFromDb result = new ResultFromDb(cnt, nick, 2, seconds, points, corMoves, incMoves, ord, corQ, incQ);
